...
//console.log('key', key, 'value', value, 'type', type);
            if (type === 'object') { /* Object || Array */
                ...
                output += '<div class="jse--row ' + rowClass + '" id="' + rowId + '"><input type="text" class="jse--key" data-level="' + lvl + '" value="' + key + '" placeholder="'+lblKey+'" /> <span class="jse--typeof" data-type="' + type + '">(' + labelText + ')</span>';
                ...
                output += '<div class="jse--row" id="' + rowId + '"><input type="text" class="jse--key" data-level="' + lvl + '" value="' + key + '" '+readonly+' placeholder="'+lblKey+'" /> <span class="jse--typeof" data-type="' + type + '">(' + labelText + ')</span><input type="' + inputValueType + '" class="jse--value" value="' + value + '" ' + checked + ' placeholder="'+lblValue+'" /><div class="jse--delete">✖</div></div>';
            }
        })
