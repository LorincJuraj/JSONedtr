...
//console.log('key', key, 'value', value, 'type', type);
            if (type === 'object') { /* Object || Array */
                ...
                output += '<div class="jse--row ' + rowClass + '" id="jse--row-' + JSONedtr.i + '"><input type="text" class="jse--key" data-level="' + lvl + '" value="' + key + '" placeholder="'+lblKey+'" /> <span class="jse--typeof" data-type="' + type + '">(' + labelText + ')</span>';
                ...
                output += '<div class="jse--row" id="jse--row-' + JSONedtr.i + '"><input type="text" class="jse--key" data-level="' + lvl + '" value="' + key + '" '+readonly+' placeholder="'+lblKey+'" /> <span class="jse--typeof" data-type="' + type + '">(' + labelText + ')</span><input type="' + inputValueType + '" class="jse--value" value="' + value + '" ' + checked + ' placeholder="'+lblValue+'" /><div class="jse--delete">✖</div></div>';
            }
        })
...
//console.log(plusO);  
    ...
    JSONedtr.init = function (data, outputElement, update) {
        ...
        html += '<div class="jse--row">\n\
            <button class="jse--copy-to-clipboard">'+lblCopyCB+'</button> \n\
            <button class="jse--paste-from-clipboard">'+lblPasteCB+'</button> \n\
        ...
        $(outputElement + ' button').click(function (e) {
            ...
            if ( o.hasClass('jse--reset') ) {
                ...
                var result = JSONedtr.copyText( JSONedtr.getDataString(), this );
                if ( result ) { alert('OK'); }
