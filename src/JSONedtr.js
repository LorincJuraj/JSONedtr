...
//console.log('key', key, 'value', value, 'type', type);
            if (type === 'object') { /* Object || Array */
                ...
                output += '<div class="jse--row ' + rowClass + '" id="' + rowId + '"><input type="text" class="jse--key" data-level="' + lvl + '" value="' + key + '" placeholder="'+lblKey+'" '+readOnlyProp+' /> <span class="jse--typeof" data-type="' + type + '">(' + labelText + ')</span>';
